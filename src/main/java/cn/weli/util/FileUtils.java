package cn.weli.util;

import cn.weli.common.constant.Constant;
import cn.weli.util.http.HttpResponse;
...
public class FileUtils {
    ...
    public static String getStringFromStream(InputStream inputStream) throws IOException {
        ...
        try {
            inReader = new InputStreamReader(inputStream, Constant.UTF8);
     ...
     * @throws Exception
     */
    public static String getStringFromStreamWith2Space(InputStream inputStream) throws IOException {
        InputStreamReader inReader = null;
        BufferedReader bf = null;
        StringBuilder sb = new StringBuilder();
        try {
